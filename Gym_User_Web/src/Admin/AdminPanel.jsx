...
return ( <div className="admin-root flex min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-white">
...
```
  ...
  >
    ...
    {/* ✅ SAFE PROGRESS BAR (NO framer-motion) */}
    {isTransitioning && (
      <div className="fixed top-0 left-0 h-[3px] w-full bg-gradient-to-r from-red-600 to-orange-500 z-[99999] animate-pulse" />
    )}
