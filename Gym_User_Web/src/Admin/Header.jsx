...
const pageTitles = {
  ...
  "/admin/settings/usermanagement": "User Management",
  "/admin/settings/reviews": "Reviews",
  ...
  "/admin/addworkouts": "Add Workouts",
  "/admin/alladdworkouts": "All Workouts",
  "/admin/member-profiles": "Member Profiles",
  "/admin/adddietplans": "Add Diet Plans",
  "/admin/alladddietplans": "All Diet Plans",
};
