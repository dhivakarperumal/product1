...
const AllWorkouts = () => {
  ...
  }, [workouts, search, categoryFilter, levelFilter, trainerFilter]);

  /* ---------------- FETCH ALL WORKOUT PROGRAMS FOR ADMIN ---------------- */
  useEffect(() => {
  ...
  const uniqueTrainers = [...new Set(workouts.map(w => w.trainerName).filter(Boolean))];
  ...
  <input
    ...
    placeholder="Search by member, trainer, goal..."
        ...
        <div className="hidden sm:block overflow-x-auto rounded-xl border border-white/10">
                ...
                filteredWorkouts.map((w, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center space-x-3">
                      ...
                      <button
                        onClick={() => navigate(`/admin/addworkouts/${w.id}`)}
          ...
          <div className="sm:hidden space-y-4">
            {filteredWorkouts.length === 0 ? (
              <div className="text-center py-6 text-gray-400">No workout programs found</div>
            ) : (
              filteredWorkouts.map((w, index) => (
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => navigate(`/admin/addworkouts/${w.id}`)} className="p-2 rounded-full bg-green-500 text-white">
                          <Edit2 size={16} />
                        </button>
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h3 className="text-2xl font-bold">
                    {selectedWorkout.memberName}'s Weekly Timetable
                  </h3>
                  <p className="text-xs text-gray-400 mt-1">
                    Trainer: {selectedWorkout.trainerName} • Duration: {selectedWorkout.durationWeeks} Weeks
                  </p>
                </div>
